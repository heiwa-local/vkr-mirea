...
def get_jobs_postings(
    ...
    try:
        query = f"SELECT v1.job_posting.id, v1.job_posting.vacancy_id, v1.job_posting.resume_id, " \
                f"v1.vacancy.job_title, v1.organization.name, v1.organization.logo_url, v1.job_posting.status, " \
